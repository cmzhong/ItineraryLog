  ...
  render(){
    ...
    return (
      <div id="lists">
        ...
        <button id="standard" className="submit" type="button" onClick={ ()=> this.props.cityClicked([]) }>Back to all Cities</button>
        <button id="delete" className="submit" type="button" onClick={ ()=> { if (window.confirm('Are you sure you want to delete this item?')) this.props.deleteDatabaseCity([ this.props.clickedCityName, this.props.clickedCityId ]) } }>Delete this City</button>
